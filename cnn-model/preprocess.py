...
# Define project-wide data paths relative to this script
CNN_BASE_DIR = os.path.dirname(__file__)
PROJECT_ROOT = os.path.join(CNN_BASE_DIR, '..')
RAW_DATA_OIL = os.path.join(PROJECT_ROOT, 'data', 'raw', 'oil')
RAW_DATA_NO_OIL = os.path.join(PROJECT_ROOT, 'data', 'raw', 'no_oil')
...
if __name__ == "__main__":
    # Use the pre-defined paths based on the project structure
    oil_dataset_dir = RAW_DATA_OIL
    no_oil_dataset_dir = RAW_DATA_NO_OIL
    output_dir = PROCESSED_DATA_DIR
    
    process_dataset(oil_dataset_dir, no_oil_dataset_dir, output_dir=output_dir)
