...
# Define base directory for CNN relative to this script
CNN_BASE_DIR = os.path.dirname(__file__)
MODELS_DIR = os.path.join(CNN_BASE_DIR, 'models')
PLOTS_DIR = os.path.join(MODELS_DIR, 'plots')
DATA_DIR = os.path.join(CNN_BASE_DIR, '..', 'data', 'processed')
...
def create_cnn_model(input_shape=(256, 256, 3)):
    ...
    # Start with an explicit Input layer (Modern Keras 3 approach)
...
def train_model(epochs=50, batch_size=16, lr=0.001):
    ...
    model_path = os.path.join(MODELS_DIR, f'oil_spill_model_{timestamp}.h5')
    ...
    # Save final model
    final_model_path = os.path.join(MODELS_DIR, f'oil_spill_model_final_{timestamp}.h5')
    ...
    json_path = os.path.join(MODELS_DIR, f'oil_spill_model_architecture_{timestamp}.json')
